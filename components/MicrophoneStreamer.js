    ...
    <div className="h-[calc(100vh-73px)] flex justify-center items-center">
      <div className="w-[40%] flex justify-between items-center">
        <div className="flex flex-col">
          <button
            ...
            className="w-fit my-10 p-5 bg-gray-200 rounded-lg"
          >
            Start Recording
          </button>
          <button
            onClick={handleStopRecording}
            className="w-fit mb-10 p-5 bg-gray-200 rounded-lg"
          >
            Stop Recording
          </button>
        ...
        <div>
          <button
            className="p-10 bg-yellow-500 rounded-xl"
      ...
      <div className="w-[40%] flex justify-center items-center">
        <textarea
          value={transcribtion}
          readOnly
          className="w-[60%] aspect-square resize-none shadow-lg shadow-black"
        ></textarea>
      </div>
    </div>
  );
